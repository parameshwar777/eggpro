  ...
  return (
    <MobileLayout>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p className="text-foreground/70">Share the love, earn rewards</p>
          </div>
        </motion.div>
      </motion.div>
      ...
      <motion.div
        ...
        className="mx-4 -mt-6 bg-primary rounded-2xl p-6 shadow-elevated"
      >
        ...
        <div className="flex items-center justify-between mt-2">
          <motion.h2
            ...
            className="text-3xl font-bold text-primary-foreground tracking-wider"
          >
            {referralCode}
          </motion.h2>
          <motion.button
      ...
      <motion.div
        ...
        className="mx-4 mt-6 bg-card rounded-2xl p-6 shadow-card"
      >
