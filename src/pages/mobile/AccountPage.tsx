  ...
  return (
    <MobileLayout>
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="gradient-warm px-4 pt-8 pb-20 rounded-b-[2rem]"
      >
        <motion.h1
      ...
      <motion.div
        ...
        className="mx-4 -mt-12 bg-card rounded-2xl p-6 shadow-elevated"
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-xs text-primary">My Home Bhooja</span>
            </div>
          </div>
        </div>
      ...
      <div className="px-4 mt-4 space-y-2">
        {menuItems.map((item, i) => (
          <motion.button
            ...
            className="w-full bg-card rounded-xl p-4 shadow-card flex items-center gap-4"
          >
